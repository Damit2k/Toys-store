		...
		<div class="container-fluid">	
			...
			<div class="row">
				<div class="col-md-6 left">
					<h1 class="cach"><b>ĐĂNG NHẬP</b></h1>
...
<!-- gio hang ben phai -->
				<div class="col-md-6 right">
					<form method="POST" action="">
										...
										<h5>Thông tin đăng nhập không hợp lệ</h5>
										<input class="timkiem-inputtk" type="text" placeholder="Tên tài khoản" value="" name="username">
										<input class="timkiem-inputtk" type="password" placeholder="Mật khẩu" value="" name="password">
										...
										<div class="taotk">
											<p class="taotk-p">Khách hàng mới? <a href="?controller=dangky" class="taotk-a"><b>Tạo tài khoản</a></b></p>
											<p>Quên mật khẩu? <a href="" class="taotk-a"><b>Khôi phục mật khẩu</b></a></p>
										</div>
									</form>
				</div>
			</div>
