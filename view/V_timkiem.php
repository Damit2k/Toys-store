	...
	<div class="main">
		<div class="container-fluid">
			...
			<div class="row justify-content-md-center giohang-header">
				<div class="col-md-4-auto">
					<p style="font-size: 15px;">Các sản phẩm qua tìm kiếm của bạn</p>
				</div>
			</div>
		</div>
		<div class="container-fluid">
			<div class="container">
				<div class="row	justify-content-md-center">
		<?php
				foreach($sptimkiem as $key => $value) {
				$b = $value['img_link'];
				$split = preg_split("(\s)",$b);
			 ?>
			<div class="col-md-2 timkiem-spcard cach">
			...
			<?php if(empty($sptimkiem)) {  ?>
			<div class="row cach khung">
				<div class="col-md-12">
					<h4 class="text">Không có sản phẩm phù hợp với tìm kiếm của bạn</h4>
				</div>
			</div>
			<?php } }?>
		</div>
