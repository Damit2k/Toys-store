			...
			<div class="row justify-content-md-center">
				...
				<div class="col-md-4">	
					<div class="icon col-md-6">	
						<a href=""><h4><i class="bi bi-person-circle"></i></h4></a>
			...
			<div class="row">
				...
				<div class="col-md-1">
					...
					<ul>
						...
						<li><a href="?controller=khachhang&id_user=<?php echo $value['id_user']?>"><i class="bi bi-circle"></i> Thông tin tài khoản</a></li>
						<?php } ?>
						<li><a href=""><i class="bi bi-circle"></i> Đổi địa chỉ</a></li>
						
						<li><i class="bi bi-circle"></i> Đăng xuất</li>
					</ul>
				</div>

<!-- gio hang ben phai -->
				<div class="col-md-7 diachi">
					<p><b>THÔNG TIN TÀI KHOẢN</b></p>
					<hr>
					<?php foreach ($kh as $key => $value) {?>
						<p><h6>Địa chỉ hiện tại</h6></p>
						<p><?php echo $value['diachi']?></p>
					<?php }?>
					<form action="" method="POST" >
						<p><h6>Đổi địa chỉ mới</h6></p>
						<input type="text" name="diachimoi" class="timkiem-inputtk">
						<button name="submit" class="btn btn-outline-secondary">Xác Nhận</button>
					</form>
