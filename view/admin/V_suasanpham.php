                     ...
                     <table class="table admin-sanpham">  
                            ...
                            <tbody> 
                               ...
                               <tr class="admin-sp">
                                    ...
                                    <td class="admin-sp-img">
                                    <?php foreach ($split as $key => $img) { ?>
                                        <img class="admin-sp-img" src="<?php echo $img?>">
                                    <?php } ?>
                                    </td>
                                    ...
                                    <td class="admin-sp-trangthai"><?php echo $value['tonkho']?></td>
                                    <td class="admin-sp-tonkho"><?php echo $value['daban']?></td>
                                    <td class="admin-sp-content"><?php echo $value['content']?></td>
                                    
                                    <td class="admin-sp-tonkho">
                                        <a href="?controller=suasanpham&delete=true" class="btn btn-danger">Xóa</a>
                               ...
                               <tr class="admin-sp admin-suasp">
                                <form action="" method="POST">
                                   ...
                                   <td class="admin-sp-price"><input type="text" name="price"></td>
                                    <td class="admin-sp-trangthai"><input type="text" name="trangthai"></td>
                                   ...
                                   <td><button name="submit" class="btn btn-primary">Cập nhật</button></td>
                                </form>
                               </tr>
                               <tr>
                                   <td>./view/img/tênảnh.dạngảnh ./view/img/tênảnh2.dạngảnh2, VD:
                                    <?php echo $value['img_link']?></td>
                               </tr>
